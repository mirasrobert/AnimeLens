...
public class R17Fragment extends Fragment {
    ...
    public R17Fragment(List<Results> listAnimes, List<Results> ovaG, List<Results> movieGList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_r17, container, false);
