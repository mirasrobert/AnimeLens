...
public class RplusFragment extends Fragment {
    ...
    public RplusFragment(List<Results> listAnimes, List<Results> ovaG, List<Results> movieGList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_rplus, container, false);
